REFINE_SYSTEM = (
    ...
    "  At most TWO 'scrub' controls; any number of 'min' controls. A scrub column MUST NOT be the\n"
    "  x-axis column — filtering the x-axis to one value collapses the chart; pick a DIFFERENT\n"
